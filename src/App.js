        ...
        <div className="content-holder">
          {!isTrue && (
            <ul className="inner-holder">
              {newHistoryList.map(eachObejct => (
                <li
                  key={eachObejct.id}
                  uniqueId={eachObejct.id}
                  className="items-holder"
                >
                  <p className="time">{eachObejct.timeAccessed}</p>
                  <div className="icon-holder">
                    <img
                      src={eachObejct.logoUrl}
                      className="icon-holder"
                      alt="domain logo"
                    />
                    <div className="logo-conetnt">
                      <p className="name">{eachObejct.title}</p>
                      <p className="website">{eachObejct.domainUrl}</p>
                    </div>
                  </div>
                  <button
                    ...
                    data-testid="delete"
                    type="button"
                    onClick={() => this.FillFunction(eachObejct.id)}
                  >
                    <img
